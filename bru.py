...
response = requests.get('https://blinkit.com/v2/listing?filters={%22brand_id%22:%20[5045]}', cookies=cookies, headers=headers)
...
response = requests.post('https://user-search.zepto.co.in/api/v3/search', headers=headers, json=json_data)
